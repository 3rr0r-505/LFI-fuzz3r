...
- Clone your forked repository: `git clone https://github.com/3rr0r-505/LFI-fuzz3r.git`
- Navigate to the project directory: `cd LFI-fuzz3r`

## Creating Issues

If you find a bug, have a question, or want to suggest a new feature, you can create an issue on GitHub:

1. Go to the [Issues](https://github.com/3rr0r-505/LFI-fuzz3r/issues) section.
